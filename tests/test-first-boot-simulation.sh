...
# =============================================================================
# NOTE: This test is SKIPPED because the installer has been moved to an
# external repository (madoslinux/mados-installer). The test would require
# cloning the external repo to run properly.
# 
# The installer functionality is tested in its own repository.
# =============================================================================
echo "Test skipped: Installer moved to external repository"
exit 0
