...
# ==============================================================================
ARCH_PKGS=(
    "hyprland" "weston" "foot" "cava" "swaync" 
...
show_overview() {
    ...
    print_kb "SUPER + RETURN" "Open Terminal (Foot)"
...
CONFIG_FOLDERS=("cava" "hypr" "foot" "swaync" "matugen" "zsh" "swayosd")
...
# Michroma Pack Installation
printf "  -> Creating temporary directory... \n"
mkdir -p /tmp/iosevka-pack

printf "  -> Downloading latest full Michroma pack... \n"
curl -fLo /tmp/iosevka-pack/Michroma.zip https://github.com/ryanoasis/nerd-fonts/releases/latest/download/Michroma.zip

printf "  -> Extracting fonts... \n"
unzip -q /tmp/iosevka-pack/Michroma.zip -d /tmp/iosevka-pack/

printf "  -> Installing fonts to MichromaNerdFont directory... \n"
mkdir -p "$TARGET_FONTS_DIR/MichromaNerdFont"
mv /tmp/iosevka-pack/*.ttf "$TARGET_FONTS_DIR/MichromaNerdFont/"
sudo cp -r ~/.local/share/fonts/MichromaNerdFont /usr/share/fonts/

printf "  -> Cleaning up temporary files... \n"
rm -rf /tmp/iosevka-pack
rm -f ~/.local/share/fonts/MichromaNerdFont/*Mono*.ttf
