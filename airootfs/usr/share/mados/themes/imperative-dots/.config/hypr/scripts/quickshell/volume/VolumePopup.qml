                        ...
                        ColumnLayout {
                            ...
                            ColumnLayout {
                                ...
                                Text {
                                    ...
                                    font.family: "Michroma"; font.weight: Font.Black; font.pixelSize: 20
                                    color: window.text
                        ...
                        delegate: Rectangle {
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    ...
                                    Text {
                                        font.family: "Michroma"; font.pixelSize: 22
                                    ...
                                    ColumnLayout {
                                        ...
                                        Text {
                                            Layout.fillWidth: true; elide: Text.ElideRight
                                            font.family: "Michroma"; font.weight: Font.Bold; font.pixelSize: 14
                                            color: isActiveNode ? window.crust : window.text
                                ...
                                RowLayout {
                                    ...
                                    Text {
                                        ...
                                        font.family: "Michroma"; font.weight: Font.Bold; font.pixelSize: 12
                                        color: window.subtext0
                                        text: model.volume + "%"
