        ...
        Rectangle {
            ...
            Row {
                ...
                Rectangle {
                    ...
                    Column {
                        ...
                        Text { 
                            ...
                            font.pixelSize: 18; font.family: "Michroma"; font.weight: Font.Black
                            color: window.ambientPrimary
                            Behavior on color { ColorAnimation { duration: 1000 } }
                ...
                Text {
                    ...
                    text: ":"
                    font.pixelSize: 22; font.family: "Michroma"; font.weight: Font.Black
                    color: window.ambientPrimary
                    Behavior on color { ColorAnimation { duration: 1000 } }
            ...
            Rectangle {
                ...
                MouseArea {
                    ...
                    onClicked: { 
                        ...
                        Quickshell.execDetached(["sh", "-c", "echo 'close' > \"${QS_IPC_FILE:-/tmp/qs_widget_state}\""]); 
                    }
                }
            }
                    ...
                    Repeater {
                        ...
                        delegate: Rectangle {
                            ...
                            Timer {
                                ...
                                onTriggered: { Quickshell.execDetached(["sh", "-c", cmd]); Quickshell.execDetached(["sh", "-c", "echo 'close' > \"${QS_IPC_FILE:-/tmp/qs_widget_state}\""]); }
                            }
                        }
                    }
                }
                        ...
                        Repeater {
                            ...
                            delegate: Item {
                                ...
                                RowLayout {
                                    ...
                                    spacing: 8
                                    Text {
                                        font.family: "Michroma"; font.pixelSize: 18
