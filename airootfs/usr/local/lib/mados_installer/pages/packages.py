...
PACKAGE_GROUPS = {
    "dev_tools": {
        ...
        "short_name": "Dev",
        "packages": [
            {"id": "base-devel", "name": "Development Essentials (gcc, make, cmake, git)", "default": True},
    ...
    "multimedia": {
        ...
        "packages": [
            ...
            {"id": "inkscape", "name": "Inkscape (Vector Graphics)", "default": False},
    ...
    "office": {
        ...
        "short_name": "Office",
        "packages": [
            {"id": "onlyoffice-desktopeditors", "name": "OnlyOffice Desktop Editors", "default": True},
            {"id": "libreoffice-fresh", "name": "LibreOffice (Writer, Calc, Impress)", "default": False},
