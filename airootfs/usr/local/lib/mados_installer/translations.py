...
TRANSLATIONS = {
    "English": {
        ...
        "exit": "Exit",
        "provisioning_title": "Automated Provisioning",
        "provisioning_desc": "Load a <b>mados-config.yaml</b> file to automate installation.\nSkip this step for manual configuration.",
        "provisioning_select": "Select Provisioning Config",
        "provisioning_browse": "Browse...",
        "provisioning_loaded": "Loaded config:",
        "provisioning_skip_btn": "Skip → Manual Setup",
        "provisioning_apply_btn": "Apply Config →",
        "pkg_no_selection": "No additional packages selected",
    ...
    "Español": {
        ...
        "exit": "Salir",
        "provisioning_title": "Provisioning Automatizado",
        "provisioning_desc": "Carga un archivo <b>mados-config.yaml</b> para automatizar la instalación.\nSaltea este paso para configuración manual.",
        "provisioning_select": "Seleccionar Configuración",
        "provisioning_browse": "Buscar...",
        "provisioning_loaded": "Config cargada:",
        "provisioning_skip_btn": "Saltar → Manual",
        "provisioning_apply_btn": "Aplicar →",
        "pkg_select_title": "Seleccionar Paquetes Adicionales",
        "pkg_select_desc": "Elige grupos opcionales de paquetes. Todos son gratuitos y open-source.",
        "pkg_dev_tools": "Herramientas de Desarrollo",
        "pkg_dev_tools_desc": "Entorno completo con IDEs, compiladores y herramientas DevOps",
        "pkg_ai_ml": "Herramientas IA/ML",
        "pkg_ai_ml_desc": "Frameworks de Inteligencia Artificial y Machine Learning",
        "pkg_multimedia": "Producción Multimedia",
        "pkg_multimedia_desc": "Herramientas de edición de audio, video e imagen",
        "pkg_office": "Oficina y Productividad",
        "pkg_office_desc": "Suites ofimáticas, clientes de email y productividad",
        "pkg_internet": "Internet y Comunicación",
        "pkg_internet_desc": "Navegadores web, mensajería y comunicación",
        "pkg_base_devel": "Herramientas Base de Desarrollo",
        "pkg_no_selection": "No se seleccionaron paquetes adicionales",
    ...
    "Français": {
        ...
        "hide_log": "▼ Masquer le journal",        "provisioning_title": "Provisionnement Automatisé",
        "provisioning_desc": "Charger un fichier mados-config.yaml",
        "provisioning_select": "Sélectionner la config",
        "provisioning_browse": "Parcourir...",
        "provisioning_loaded": "Config chargée:",
        "provisioning_skip_btn": "Passer → Manuel",
        "provisioning_apply_btn": "Appliquer →",
        "pkg_no_selection": "Aucun paquet sélectionné",
    ...
    "Deutsch": {
        ...
        "hide_log": "▼ Protokoll ausblenden",        "provisioning_title": "Automatisierte Bereitstellung",
        "provisioning_desc": "Laden Sie eine mados-config.yaml",
        "provisioning_select": "Konfiguration wählen",
        "provisioning_browse": "Durchsuchen...",
        "provisioning_loaded": "Konfiguration geladen:",
        "provisioning_skip_btn": "Überspringen → Manuell",
        "provisioning_apply_btn": "Anwenden →",
        "pkg_no_selection": "Keine Pakete ausgewählt",
    ...
    "中文": {
        ...
        "show_log": "▶ 显示日志",
        "hide_log": "▼ 隐藏日志",        "provisioning_title": "自动化配置",
        "provisioning_desc": "加载 mados-config.yaml 文件",
        "provisioning_select": "选择配置文件",
        "provisioning_browse": "浏览...",
        "provisioning_loaded": "已加载配置:",
        "provisioning_skip_btn": "跳过 → 手动",
        "provisioning_apply_btn": "应用 →",
        "pkg_no_selection": "未选择额外软件包",
    ...
    "日本語": {
        ...
        "show_log": "▶ ログを表示",
        "hide_log": "▼ ログを非表示",        "provisioning_title": "自動プロビジョニング",
        "provisioning_desc": "mados-config.yaml ファイル",
        "provisioning_select": "設定を選択",
        "provisioning_browse": "参照...",
        "provisioning_loaded": "読み込まれた設定:",
        "provisioning_skip_btn": "スキップ → 手動",
        "provisioning_apply_btn": "適用 →",
        "pkg_no_selection": "追加パッケージなし",
