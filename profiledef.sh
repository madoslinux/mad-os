...
bootstrap_tarball_compression=('zstd' '-c' '-T0' '-zstd-level' '19')
file_permissions=(
  ["/etc/shadow"]="0:0:400"
  ...
  ["/usr/local/lib/mados_installer/scripts/"]="0:0:755"
  ["/usr/local/lib/mados_installer/scripts/configure-system.sh"]="0:0:755"
  ["/usr/local/lib/mados_installer/scripts/apply-configuration.sh"]="0:0:755"
  ["/usr/local/lib/mados_installer/scripts/rebuild-initramfs.sh"]="0:0:755"
  ["/usr/local/lib/mados_installer/scripts/setup-plymouth.sh"]="0:0:755"
  ...
  ["/usr/local/bin/mados-post-install"]="0:0:755"
  ["/usr/local/bin/mados-post-install-cleanup"]="0:0:755"
  ["/usr/local/bin/mados-install-aur-packages"]="0:0:755"
  ...
  ["/usr/local/bin/mados-safe-mode"]="0:0:755"
  ["/usr/local/bin/mados-graphical-session-setup"]="0:0:755"
  ["/usr/local/bin/mados-graphical-session-cleanup"]="0:0:755"
  ["/usr/local/bin/detect-legacy-hardware-debug"]="0:0:755"
  ["/usr/local/bin/mados-set-password"]="0:0:755"
  ["/etc/systemd/system/mados-set-password.service"]="0:0:644"
  ["/usr/local/bin/hyprland-session"]="0:0:755"
  ["/usr/local/bin/sway-session"]="0:0:755"
  ["/etc/systemd/system/mados-hardware-config.service"]="0:0:644"
  ["/etc/systemd/system/mados-update-check.service"]="0:0:644"
  ["/etc/systemd/system/mados-graphical-session.service"]="0:0:644"
  ["/etc/systemd/system/sshd.service"]="0:0:644"
  ["/etc/systemd/system/sshd-ready.service"]="0:0:644"
  ["/etc/systemd/system/ssh-genkeys.service"]="0:0:644"
